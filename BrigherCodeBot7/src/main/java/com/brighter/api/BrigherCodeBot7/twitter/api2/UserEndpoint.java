...
import com.brighter.api.BrigherCodeBot7.converter.UserConverter;
import com.brighter.api.BrigherCodeBot7.domain.User;
import com.brighter.api.BrigherCodeBot7.domain.http.userlookup.UserLookupResponse;
...
public class UserEndpoint extends TwitterApi2Endpoint {
    ...
    @Autowired
    public UserEndpoint(Twitter twitter, RestTemplate rt, @Value("${bearerToken}") String bearerToken, UserConverter userConverter) {
    ...
    public User getById(long id) {
        ...
        final ResponseEntity<UserLookupResponse> response = rt.exchange(uri, HttpMethod.GET, userResponseEntity, UserLookupResponse.class);
